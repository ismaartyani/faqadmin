...
<head>
  ...
  <link rel="icon" href="img/dot_id.png">
  ...
  <!-- Datatables -->
  <link rel="stylesheet" href="{{asset('public/assets/vendor/datatables/datatables.min.css')}}">
  <!-- Ionicons -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>FAQ</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{asset('public/admin/dist/img/dot_id.png')}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset('public/admin/dist/img/dot_id.png')}}" class="user-image" alt="User Image">
              <span class="hidden-xs">PANDI.ID</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="{{ url('admin/navigator') }}">
            <i class="fa fa-th"></i> <span>Navigator</span>
        ...
        <li>
          <a href="{{ url('admin/konten') }}">
            <i class="fa fa-th"></i> <span>Konten</span>
            <span class="pull-right-container">
              <!-- <small class="label pull-right bg-green">new</small> -->
            </span>
          </a>
        ...
        <!-- <li>
          <a href="{{ url('admin/kontak') }}">
            <i class="fa fa-th"></i> <span>Kontak</span>
            <span class="pull-right-container">
              <!-- <small class="label pull-right bg-green">new</small> -->
            <!-- </span>
          </a>
        ...
        <!-- <li> -->
          <!-- <a href="pages/widgets.html"> -->
            <!-- <i class="fa fa-th"></i> <span>Social Media</span> -->
            <!-- <span class="pull-right-container"> -->
              <!-- <small class="label pull-right bg-green">new</small> -->
            <!-- </span> -->
          <!-- </a> -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="https://adminlte.io">PANDI</a>.</strong> All rights
    reserved.
  </footer>
  ...
  <div class="control-sidebar-bg"></div>
    ...
    <!-- ./wrapper -->
    <!-- Sweetalert2 -->
<script src="{{asset('public/assets/vendor/sweetalert2/sweetalert2.all.min.js') }}"></script>
<!-- jQuery 3 -->
